...
function wp_bootstrap_starter_setup() {
	...
	register_nav_menus( array(
        ...
        'footer-one' => esc_html__( 'Footer One', 'wp-bootstrap-starter' ),
        'footer-two' => esc_html__( 'Footer Two', 'wp-bootstrap-starter' ),
        'footer-three' => esc_html__( 'Footer Three', 'wp-bootstrap-starter' ),
	) );
...
function wp_bootstrap_starter_widgets_init() {
    register_sidebar( array(
        ...
        'id'            => 'footer',
        'description'   => esc_html__( 'Widget area directly above the main footer.', 'wp-bootstrap-starter' ),
...
function wp_bootstrap_starter_scripts() {
    ...
    wp_enqueue_style('gutenberg-editor-styles', get_template_directory_uri() . '/css/editor.css', false, '');
